...
public final class QueryUtils {
     ...
     */
    public static List<News> fetchNewsArticles(String requestUrl) {
        // Create URL object
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // Create JSONObject associated with the key called "response"
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Declare a string variable to hold the name of the author
